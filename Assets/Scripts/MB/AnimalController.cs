...
public class AnimalController : ActorController {
    ...
    public override void Start() {
        base.Start();
        SnapToGround();
        targetLocation = GameController.instance.SnapToGround(transform.position);
	...
	public override void FixedUpdate() {
        ...
        if (wild) {
            ...
            if (MoveTowards(targetLocation)) {
                ...
                targetLocation = GameController.instance.SnapToGround(targetLocation + wanderRange * (Quaternion.Euler(0, Random.Range(-180, 180), 0) * transform.forward));
            }
